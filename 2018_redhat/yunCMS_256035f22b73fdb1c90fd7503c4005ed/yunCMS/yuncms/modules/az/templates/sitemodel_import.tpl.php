...
<div class="subnav">
    ...
    <a href='?m=yp&c=ypmodel&a=init&menuid=<?php echo $_GET['menuid']?>&pc_hash=<?php echo $_SESSION['pc_hash']?>' ><em><?php echo L('model_manage')?></em></a><span>|</span><a href='javascript:;' class="on"><em><?php echo L('import_model')?></em></a>
    </div>
</div>
