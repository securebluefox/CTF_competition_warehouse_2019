...
class User(BaseModel):
    ...
    invite_num = Column(INTEGER, default=0)
    password = Column(VARCHAR(60))
    integral = Column(FLOAT, default=200.0)
    wallet_addr = Column(VARCHAR(200), default='')
    private_key = Column(VARCHAR(100), default='')
    diff_hash = Column(VARCHAR(100), default='')
